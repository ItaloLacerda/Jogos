function start() { // Inicio da função start()
    //Ocultando a Div com o "id = inicio"
	$("#start").hide();
	
    //Crinado Novas Divs Com os "ids"
    ...
    $("#game-background").append("<div id='energia'></div>");
	...
	$("#game-background").css("background-position",esquerda-1);
    ...
    somExplosao.play();
	$("#game-background").append("<div id='explosao1'></div");
    ...
    function explosao3(amigoX,amigoY) {
        ...
        somPerdido.play();
        $("#game-background").append("<div id='explosao3' class='animation4'></div");
